...
public class ProportionalElectionUnionEntriesUpdateTest : BaseDataProcessorTest
{
    ...
    public async Task TestAdjustElectionsCountOnUnionEndResults()
    {
        ...
        await ModifyDbEntities<ProportionalElectionEndResult>(
            x => x.ProportionalElectionId == ZhMockedData.ProportionalElectionGuidKtratWinterthur,
        ...
        await TestEventPublisher.Publish(
            ...
            new ProportionalElectionUnionEntriesUpdated
            {
                ProportionalElectionUnionEntries = new ProportionalElectionUnionEntriesEventData
                {
                    ...
                    ProportionalElectionIds =
                    {
                            ZhMockedData.ProportionalElectionGuidKtratDietikon.ToString(),
                    },
                },
            });
        ...
        unionEndResult.TotalCountOfElections.Should().Be(1);
        unionEndResult.CountOfDoneElections.Should().Be(1);
        ...
        await TestEventPublisher.Publish(
            ...
            new ProportionalElectionUnionEntriesUpdated
            {
                ProportionalElectionUnionEntries = new ProportionalElectionUnionEntriesEventData
                {
                    ...
                    {
                        ZhMockedData.ProportionalElectionGuidKtratDietikon.ToString(),
                        ZhMockedData.ProportionalElectionGuidKtratMeilen.ToString(),
                        ZhMockedData.ProportionalElectionGuidKtratWinterthur.ToString(),
                    },
                },
            });
