...
public class VoteResultPrepareCorrectionFinishedAndAuditedTentativelyTest : VoteResultBaseTest
{
    private const string IdNotFound = "8b89b1a7-90a8-4b38-9422-812545bbadbb";
    private const string IdBadFormat = "8b89b1a790a8-4b38-9422-812545bbadbb";

    public VoteResultPrepareCorrectionFinishedAndAuditedTentativelyTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    public async Task TestShouldThrowNotFound()
    {
        ...
        await AssertStatus(
            async () => await ErfassungElectionAdminClient.PrepareCorrectionFinishedAndAuditedTentativelyAsync(
                new VoteResultPrepareCorrectionFinishedAndAuditedTentativelyRequest
                {
    ...
    private VoteResultPrepareCorrectionFinishedAndAuditedTentativelyRequest NewValidRequest()
    {
        return new VoteResultPrepareCorrectionFinishedAndAuditedTentativelyRequest
        {
