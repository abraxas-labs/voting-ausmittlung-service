...
public class DeleteVoteResultBallotRequestTest : ProtoValidatorBaseTest<DeleteVoteResultBallotRequest>
{
    protected override IEnumerable<DeleteVoteResultBallotRequest> OkMessages()
    {
    ...
    protected override IEnumerable<DeleteVoteResultBallotRequest> NotOkMessages()
    {
    ...
    private DeleteVoteResultBallotRequest NewValidRequest(Action<DeleteVoteResultBallotRequest>? action = null)
    {
        var request = new DeleteVoteResultBallotRequest
        {
