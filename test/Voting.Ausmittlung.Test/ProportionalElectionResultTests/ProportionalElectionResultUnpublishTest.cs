...
public class ProportionalElectionResultUnpublishTest : ProportionalElectionResultBaseTest
{
    private const string IdNotFound = "8b89b1a7-90a8-4b38-9422-812545bbadbb";
    private const string IdBadFormat = "8b89b1a790a8-4b38-9422-812545bbadbb";

    public ProportionalElectionResultUnpublishTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    public async Task TestShouldReturnAsMonitoringElectionAdmin()
    {
        ...
        EventPublisherMock.GetSinglePublishedEvent<ProportionalElectionResultUnpublished>().MatchSnapshot();
    }
    ...
    public async Task TestShouldCreateSignature()
    {
        await TestEventWithSignature(ContestMockedData.IdStGallenEvoting, async () =>
        {
            ...
            await RunToPublished();
            await MonitoringElectionAdminClient.UnpublishAsync(NewValidRequest());
            return EventPublisherMock.GetSinglePublishedEventWithMetadata<ProportionalElectionResultUnpublished>();
        });
    }
    ...
    public async Task TestProcessor()
    {
        ...
        await MonitoringElectionAdminClient.UnpublishAsync(NewValidRequest());
        await RunEvents<ProportionalElectionResultUnpublished>();
    ...
    private ProportionalElectionResultUnpublishRequest NewValidRequest(Action<ProportionalElectionResultUnpublishRequest>? customizer = null)
    {
        var r = new ProportionalElectionResultUnpublishRequest
        {
            ElectionResultIds =
                {
