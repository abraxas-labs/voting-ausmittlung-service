...
public class MajorityElectionResultGetBundleTest : BaseTest<MajorityElectionResultBundleService.MajorityElectionResultBundleServiceClient>
{
    private const string IdNotFound = "a5be0aba-9e39-407c-ac61-ffd2fa08f410";

    public MajorityElectionResultGetBundleTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    public override async Task InitializeAsync()
    {
        ...
        {
            db.MajorityElectionResultBallotLogs.Add(new MajorityElectionResultBallotLog
            {
                BallotId = MajorityElectionResultBallotMockedData.StGallenBallot1.Id,
            ...
            db.MajorityElectionResultBallotLogs.Add(new MajorityElectionResultBallotLog
            {
                BallotId = MajorityElectionResultBallotMockedData.StGallenBallot3.Id,
                Timestamp = MockedClock.UtcNowDate,
                User = new User
                {
                    FirstName = "first",
    ...
    public async Task TestShouldThrowOtherTenant()
    {
        await AssertStatus(
            async () => await ErfassungElectionAdminClient.GetBundleAsync(NewValidRequest(r =>
                r.BundleId = MajorityElectionResultBundleMockedData.IdKircheBundle1)),
    ...
    private GetMajorityElectionResultBundleRequest NewValidRequest(Action<GetMajorityElectionResultBundleRequest>? customizer = null)
    {
        var r = new GetMajorityElectionResultBundleRequest
        {
