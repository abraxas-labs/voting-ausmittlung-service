...
public abstract class VoteResultBundleBaseTest : PoliticalBusinessResultBaseTest<VoteResultBundleService.VoteResultBundleServiceClient>
{
    ...
    {
        await RunOnBundle<VoteResultBundleReviewSucceeded>(
            bundleId,
    ...
    {
        await RunOnBundle<VoteResultBundleDeleted>(
            bundleId,
    ...
    {
        await RunOnBundle<VoteResultBallotCreated>(
            bundleId,
            aggregate =>
            {
    ...
    {
        await RunOnBundle<VoteResultBallotUpdated>(
            bundleId,
            aggregate =>
            {
