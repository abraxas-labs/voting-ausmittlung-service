...
public class PdfSecondaryMajorityElectionEndResultDetailExportTest : PdfExportBaseTest
{
    ...
    protected override string NewRequestExpectedFileName => "Majorz_Detailergebnisse_short2 de_20290212.pdf";

    protected override string TemplateKey => AusmittlungPdfSecondaryMajorityElectionTemplates.EndResultDetailProtocol.Key;
