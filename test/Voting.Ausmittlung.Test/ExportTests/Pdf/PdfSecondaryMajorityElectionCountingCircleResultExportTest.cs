...
public class PdfSecondaryMajorityElectionCountingCircleResultExportTest : PdfExportBaseTest
{
    public PdfSecondaryMajorityElectionCountingCircleResultExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "Majorz_Gemeindeprotokoll_short3 de_20290212.pdf";

    protected override string TemplateKey => AusmittlungPdfSecondaryMajorityElectionTemplates.CountingCircleProtocol.Key;
