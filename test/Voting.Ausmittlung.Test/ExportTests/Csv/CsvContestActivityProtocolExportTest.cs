...
public class CsvContestActivityProtocolExportTest : CsvContestActivityProtocolExportBaseTest
{
    public CsvContestActivityProtocolExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    public async Task TestPdfAsContestManagerImmediatelyAfterTestingPhaseEnded()
    {
        ...
        await TestCsvSnapshot(NewRequest(), NewRequestExpectedFileName, "_tp_ended_immediately");
    }
