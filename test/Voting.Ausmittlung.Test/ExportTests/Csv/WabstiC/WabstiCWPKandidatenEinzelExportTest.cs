...
public class WabstiCWPKandidatenEinzelExportTest : CsvExportBaseTest
{
    public WabstiCWPKandidatenEinzelExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WP_Kandidaten_Uzwil.csv";
        ...
        return new GenerateResultExportsRequest
        {
            ...
            ExportTemplateIds = new List<Guid>
            {
                AusmittlungUuidV5.BuildExportTemplate(
                    AusmittlungWabstiCTemplates.WPKandidatenEinzel.Key,
