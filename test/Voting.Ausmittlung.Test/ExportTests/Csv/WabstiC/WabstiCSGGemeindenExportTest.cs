...
public class WabstiCSGGemeindenExportTest : CsvExportBaseTest
{
    public WabstiCSGGemeindenExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
            ...
            ResultExportRequests =
                {
                    ...
                    {
                        Key = AusmittlungWabstiCTemplates.SGGemeinden.Key,
                    },
                },
        };
    }
