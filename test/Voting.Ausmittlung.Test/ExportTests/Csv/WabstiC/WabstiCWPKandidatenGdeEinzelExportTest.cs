...
public class WabstiCWPKandidatenGdeEinzelExportTest : CsvExportBaseTest
{
    public WabstiCWPKandidatenGdeEinzelExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WP_KandidatenGde_Gossau.csv";
        ...
        return new GenerateResultExportsRequest
        {
            ...
            ExportTemplateIds = new List<Guid>
            {
                AusmittlungUuidV5.BuildExportTemplate(
                    AusmittlungWabstiCTemplates.WPKandidatenGdeEinzel.Key,
