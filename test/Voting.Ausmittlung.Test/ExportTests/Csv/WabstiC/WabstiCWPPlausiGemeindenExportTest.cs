...
public class WabstiCWPPlausiGemeindenExportTest : CsvExportBaseTest
{
    public WabstiCWPPlausiGemeindenExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WP_PlausiGemeinden.csv";
            ...
            ResultExportRequests =
                {
                    ...
                    {
                        Key = AusmittlungWabstiCTemplates.WPPlausiGemeinden.Key,
                    },
                },
        };
    }
