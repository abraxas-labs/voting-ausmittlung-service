...
public class WabstiCWMPlausiGemeindenExportTest : CsvExportBaseTest
{
    public WabstiCWMPlausiGemeindenExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WM_PlausiGemeinden.csv";
            ...
            ResultExportRequests =
                {
                    ...
                    {
                        Key = AusmittlungWabstiCTemplates.WMPlausiGemeinden.Key,
                    },
                },
        };
    }
