...
public class WabstiCWPListenGdeExportTest : CsvExportBaseTest
{
    public WabstiCWPListenGdeExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WP_ListenGde.csv";
            ...
            ResultExportRequests =
                {
                    ...
                    {
                        Key = AusmittlungWabstiCTemplates.WPListenGde.Key,
                    },
                },
        };
    }
