...
public class WabstiCWPKandidatenGdeExportTest : CsvExportBaseTest
{
    public WabstiCWPKandidatenGdeExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WP_KandidatenGde.csv";
            ...
            ResultExportRequests =
                {
                    ...
                    {
                        Key = AusmittlungWabstiCTemplates.WPKandidatenGde.Key,
                    },
                },
        };
    }
