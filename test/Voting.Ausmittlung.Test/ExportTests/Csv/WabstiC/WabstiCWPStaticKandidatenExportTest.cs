...
public class WabstiCWPStaticKandidatenExportTest : CsvExportBaseTest
{
    public WabstiCWPStaticKandidatenExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WPStatic_Kandidaten.csv";
            ...
            ResultExportRequests =
                {
                    ...
                    {
                        Key = AusmittlungWabstiCTemplates.WPStaticKandidaten.Key,
                    },
                },
        };
    }
