...
public class WabstiCWPListenGdeEinzelExportTest : CsvExportBaseTest
{
    public WabstiCWPListenGdeEinzelExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WP_ListenGde_Gossau.csv";
        ...
        return new GenerateResultExportsRequest
        {
            ...
            ExportTemplateIds = new List<Guid>
            {
                AusmittlungUuidV5.BuildExportTemplate(
                    AusmittlungWabstiCTemplates.WPListenGdeEinzel.Key,
