...
public class WabstiCWMWahlExportTest : CsvExportBaseTest
{
    public WabstiCWMWahlExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WM_Wahl.csv";
