...
public class WabstiCWPGemeindenEinzelExportTest : CsvExportBaseTest
{
    public WabstiCWPGemeindenEinzelExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WP_Gemeinden_Uzwil.csv";
        ...
        return new GenerateResultExportsRequest
        {
            ...
            ExportTemplateIds = new List<Guid>
            {
                AusmittlungUuidV5.BuildExportTemplate(
                    AusmittlungWabstiCTemplates.WPGemeindenEinzel.Key,
