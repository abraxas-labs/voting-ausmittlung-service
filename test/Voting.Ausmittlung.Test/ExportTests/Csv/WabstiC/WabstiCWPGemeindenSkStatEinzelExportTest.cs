...
public class WabstiCWPGemeindenSkStatEinzelExportTest : CsvExportBaseTest
{
    public WabstiCWPGemeindenSkStatEinzelExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WP_Gemeinden_SK_STAT_Uzwil.csv";
    ...
    protected override async Task SeedData()
    {
        ...
        await ModifyDbEntities<DomainOfInfluence>(
            x => x.BasisDomainOfInfluenceId == Guid.Parse(DomainOfInfluenceMockedData.IdBund),
        ...
        return new GenerateResultExportsRequest
        {
            ...
            ExportTemplateIds = new List<Guid>
            {
                AusmittlungUuidV5.BuildExportTemplate(
                    AusmittlungWabstiCTemplates.WPGemeindenSkStatEinzel.Key,
