...
public class WabstiCWPWahlExportTest : CsvExportBaseTest
{
    public WabstiCWPWahlExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WP_Wahl.csv";
