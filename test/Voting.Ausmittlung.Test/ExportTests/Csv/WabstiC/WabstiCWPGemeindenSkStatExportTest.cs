...
public class WabstiCWPGemeindenSkStatExportTest : CsvExportBaseTest
{
    public WabstiCWPGemeindenSkStatExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WP_Gemeinden_SK_STAT.csv";
        ...
        return new GenerateResultExportsRequest
        {
            ...
            ExportTemplateIds = new List<Guid>
            {
                AusmittlungUuidV5.BuildExportTemplate(
                    AusmittlungWabstiCTemplates.WPGemeindenSkStat.Key,
