...
public class WabstiCWMKandidatenGdeExportTest : CsvExportBaseTest
{
    public WabstiCWMKandidatenGdeExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WM_KandidatenGde.csv";
            ...
            ResultExportRequests =
                {
                    ...
                    {
                        Key = AusmittlungWabstiCTemplates.WMKandidatenGde.Key,
                    },
                },
        };
    }
