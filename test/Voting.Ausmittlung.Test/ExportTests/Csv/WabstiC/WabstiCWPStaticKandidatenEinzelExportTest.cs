...
public class WabstiCWPStaticKandidatenEinzelExportTest : CsvExportBaseTest
{
    public WabstiCWPStaticKandidatenEinzelExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WPStatic_Kandidaten_Uzwil.csv";
        ...
        return new GenerateResultExportsRequest
        {
            ...
            ExportTemplateIds = new List<Guid>
            {
                AusmittlungUuidV5.BuildExportTemplate(
                    AusmittlungWabstiCTemplates.WPStaticKandidatenEinzel.Key,
