...
public class WabstiCWPListenGdeSkStatEinzelExportTest : CsvExportBaseTest
{
    public WabstiCWPListenGdeSkStatEinzelExportTest(TestApplicationFactory factory)
        : base(factory)
    {
    }
    ...
    protected override string NewRequestExpectedFileName => "WP_ListenGde_SK_STAT_Gossau.csv";
        ...
        return new GenerateResultExportsRequest
        {
            ...
            ExportTemplateIds = new List<Guid>
            {
                AusmittlungUuidV5.BuildExportTemplate(
                    AusmittlungWabstiCTemplates.WPListenGdeSkStatEinzel.Key,
