...
namespace Voting.Ausmittlung.Data.Migrations
{
    ...
    [Migration("20250205092740_AddPoliticalBusinessResultBundleLogs")]
    partial class AddPoliticalBusinessResultBundleLogs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voting.Ausmittlung.Data.Models.MajorityElectionResultResultBundleLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Voting.Ausmittlung.Data.Models.ProportionalElectionResultResultBundleLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Voting.Ausmittlung.Data.Models.VoteResultResultBundleLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Voting.Ausmittlung.Data.Models.MajorityElectionResultResultBundleLog", b =>
                {
                    ...
                    b.OwnsOne("Voting.Ausmittlung.Data.Models.User", "User", b1 =>
                        {
                            b1.Property<Guid>("MajorityElectionResultResultBundleLogId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("MajorityElectionResultResultBundleLogId");

                            b1.ToTable("MajorityElectionResultBundleLogs");

                            b1.WithOwner()
                                .HasForeignKey("MajorityElectionResultResultBundleLogId");
                        });
            ...
            modelBuilder.Entity("Voting.Ausmittlung.Data.Models.ProportionalElectionResultResultBundleLog", b =>
                {
                    ...
                    b.OwnsOne("Voting.Ausmittlung.Data.Models.User", "User", b1 =>
                        {
                            b1.Property<Guid>("ProportionalElectionResultResultBundleLogId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("ProportionalElectionResultResultBundleLogId");

                            b1.ToTable("ProportionalElectionResultBundleLogs");

                            b1.WithOwner()
                                .HasForeignKey("ProportionalElectionResultResultBundleLogId");
                        });
            ...
            modelBuilder.Entity("Voting.Ausmittlung.Data.Models.VoteResultResultBundleLog", b =>
                {
                    ...
                    b.OwnsOne("Voting.Ausmittlung.Data.Models.User", "User", b1 =>
                        {
                            b1.Property<Guid>("VoteResultResultBundleLogId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("VoteResultResultBundleLogId");

                            b1.ToTable("VoteResultBundleLogs");

                            b1.WithOwner()
                                .HasForeignKey("VoteResultResultBundleLogId");
                        });
