...
public class WabstiCWPListenGdeSkStatRenderService : WabstiCWPBaseRenderService
{
    public WabstiCWPListenGdeSkStatRenderService(TemplateService templateService, IDbRepository<DataContext, ProportionalElection> repo)
    ...
    public override async Task<FileModel> Render(ReportRenderContext ctx, CancellationToken ct = default)
    {
        var results = Repo.Query()
            ...
            .Select(x => new Data
            {
                ...
                UnmodifiedListsCount = x.UnmodifiedListsCount,
                ModifiedListsCount = x.ModifiedListsCount,
    ...
    private class Data : IWabstiCPoliticalResultData
    {
        ...
        [Name("AnzahlWzUnveraendert")]
        public int? UnmodifiedListsCount { get; set; }

        [Name("AnzahlWzVeraendert")]
        ...
        public void ResetDataIfSubmissionNotDone()
        {
            ...
            BlankRowsCount = null;
            UnmodifiedListsCount = null;
            ModifiedListsCount = null;
        }
    }
}
