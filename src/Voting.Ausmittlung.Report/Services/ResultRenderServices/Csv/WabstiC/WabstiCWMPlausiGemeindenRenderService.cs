...
public class WabstiCWMPlausiGemeindenRenderService : IRendererService
{
    ...
    public WabstiCWMPlausiGemeindenRenderService(
            ...
            .Select(x => new
            {
                PrimaryResults = x.Results
                    ...
                    .Select(y => new Data
                    {
                        ...
                        CountOfBlankBallots = y.CountOfVoters.ConventionalBlankBallots.GetValueOrDefault(),
