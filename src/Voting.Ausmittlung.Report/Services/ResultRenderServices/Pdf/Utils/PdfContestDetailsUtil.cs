...
public static class PdfContestDetailsUtil
{
    public static void FilterAndBuildVotingCardTotals(PdfContestDetails? details, DomainOfInfluenceType domainOfInfluenceType)
    {
