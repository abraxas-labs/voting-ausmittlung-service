...
public class PdfProportionalElectionListEndResult
{
    ...
    [XmlElement("ProportionalElectionCandidateEndResult")]
    public List<PdfProportionalElectionCandidateEndResult>? CandidateEndResults { get; set; }
    ...
    public bool ShouldSerializeNumberOfMandates() => NumberOfMandates.HasValue;
}
