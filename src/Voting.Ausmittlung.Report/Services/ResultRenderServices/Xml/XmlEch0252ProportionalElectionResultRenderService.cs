...
public class XmlEch0252ProportionalElectionResultRenderService : XmlEch0252ProportionalElectionResultRenderServiceBase
{
    ...
    protected override bool IncludeCandidateListResultsInfo => false;
}
