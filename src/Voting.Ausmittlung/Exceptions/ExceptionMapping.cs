...
internal readonly struct ExceptionMapping
{
    ...
    private static ExceptionMapping Map(Exception ex)
        => ex switch
        {
            ...
            ReviewModifiedBundleForbiddenException _ => new ExceptionMapping(StatusCode.PermissionDenied, StatusCodes.Status403Forbidden),
            ...
            Ech0110RequiredException _ => new ExceptionMapping(StatusCode.InvalidArgument, StatusCodes.Status400BadRequest, true),
